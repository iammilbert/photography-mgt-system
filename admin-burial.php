...
<?php include('db_connect.php'); ?>
    ...
    <?php while($gallery_row = mysqli_fetch_assoc($query)): ?>
            <div class="col-12 col-sm-6 col-md-4">
              ...
              <img style="width: 400px; height: 400px" alt="img" src="assets/images/burial/<?php echo $gallery_row['picture']; ?>">                
                <div class="card-footer">
                  <div class="text-center">
                    <a href="admin-burial.php?delete=<?php echo $gallery_row['id']; ?>" class="btn btn-danger">
                      <i class="fas fa-trash"></i>
                    </a>
                    <a href="admin-edit-burial.php?id=<?php echo $gallery_row['id'] ?>" class="btn btn-success">
