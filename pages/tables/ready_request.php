          ...
          <div class="card">
            ...
            <?php endif ?>
              ...
              <form class="form" method="POST">
                ...
                <?php
                $sql="SELECT customer_request.customer_id, customer_request.request, customer_request.event_id, customer_request.delivery_type, customer_request.dateOdered, signup.email, signup.mobile, customer_request.status 
          ...
          ?>
                    <tr>
                      <td><?php echo $row['event_id']; ?></td>
                        ...
                        <td style="color: red"><?php echo $row['email']; ?></td>
                        ...
                        <td>
                            <?php
                              ...
                              if($row['status']==0){
                                  ...
                                  echo "<a href='../../processing-request.php?id=".$row['customer_id']."' class='btn btn-flat btn-success'> Process</a>";
                                }
                                elseif($row['status']==2){
