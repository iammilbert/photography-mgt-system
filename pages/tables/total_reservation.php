...
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];
            ...
            $sql = "DELETE FROM customer_reservation WHERE id = '".$id."'";
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            $sql="SELECT customer_reservation.transaction_id, customer_reservation.event, customer_reservation.date, customer_reservation.time, customer_reservation.shot, customer_reservation.transaction_id, customer_reservation.status, customer_reservation.customer_id, customer_reservation.reason
          ...
          ?>
                    <tr>
                        ...
                        <td>
                            <?php
                                if($row['status']==1){
                                    echo "<p id=str".$row['customer_id'].">Successful</p>";
                                }

                                elseif($row['status']==2){
                                    echo "<p id=str".$row['customer_id'].">Unsuccessful</p>";
                                }
                                else{
                                    echo "<p id=str".$row['customer_id'].">Pending</p>";
                                };
                        ...
                        <td><a  class="btn btn-danger" href="total_reservation.php?delete=<?php echo $row['customer_id']; ?>" name="delete" ><i class='fas fa-trash'></i></a></td>
                    </tr>
