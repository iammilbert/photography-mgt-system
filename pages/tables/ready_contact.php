          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="form" method="POST">
                ...
                $result = mysqli_query($conn,"SELECT * FROM contact_us ORDER BY id ASC");
                ...
                ?>
                   <tr>
                        ...
                        <td><a href="../../admin_reply_contact.php?id=<?php echo $row['id']; ?>" class='btn btn-sm btn-primary' name="edit" ><i class='fa fa-envelope'> Send</i></a></td>
