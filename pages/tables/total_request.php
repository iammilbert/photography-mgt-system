          ...
          <div class="card">
            ...
            <?php endif ?>
              ...
              <form class="form" method="POST">
                ...
                <?php
                $sql="SELECT customer_request.customer_id, customer_request.request, customer_request.event_id, customer_request.delivery_type, customer_request.dateOdered, signup.mobile, customer_request.status, customer_request.reason 
          ...
          ?>
                    <tr>
                      <td><?php echo $row['event_id']; ?></td>
                        ...
                        <td style="color: green"><?php echo $row['dateOdered']; ?></td>
                        <td style="color: green"><?php echo $row['mobile']; ?></td>
                       ...
                       <td>
                        ...
                        <td><a  class="btn btn-danger" href="total_request.php?delete=<?php echo $row['customer_id']; ?>" name="delete" ><i class='fas fa-trash'></i></a></td>
                    </tr>
