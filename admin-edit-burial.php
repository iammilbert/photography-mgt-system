      ...
      <div class="row">
        ...
        <div class="col-8">
          ...
          <div class="card">
            ...
            ?>
            <a href="admin-burial.php" style="color: blue">Refresh</a>
                </div>
            ...
            <?php endif ?>
             ...
             <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <a href="admin-burial.php" class="btn btn-lg btn-danger"><i class="fa fa-image"> Burial Gallery</i></a>
                </div>               
