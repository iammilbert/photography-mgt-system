...
$request_row = mysqli_fetch_assoc($query);
...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE customer_request SET status ='".$status."', reason = '".$reason."' WHERE customer_id = '".$id."'";
...
if ($query) {
  # code...
      ...
      header('location: pages/tables/total_request.php');
      ...
      <div class="row">
        ...
        <div class="col-8">
          <div class="form-group">
            <h3>Processing <span style="color: orange"><?php echo $request_row['firstName']; ?> <?php echo $request_row['lastName']; ?> </span>  Request</h3>
          ...
          <div class="card">
            ...
            ?>
            <a href="total_request.php" style="color: blue">Refresh</a>
                </div>
            ...
            <?php endif ?>
             ...
             <form class="form" method="POST">
              ...
              <div class="form-group">
                <label>Reason (if not Successful)</label>
                 <textarea name="reason" class="form-control" placeholder="Type Your Reason"></textarea>
              </div>
                ...
                <div class="form-group">
                        ...
                        <a href="ready_request.php" class="btn btn-flat btn-danger">Cancel</a>
                </div>               
