...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($query)
    {
        move_uploaded_file($pic_tmp_name, "assets/images/wedding/$pic_name");
      ...
      <div class="row">
        ...
        <div class="col-8">
          ...
          <div class="card">
            ...
            ?>
            <a href="admin-wedding.php" style="color: blue">Refresh</a>
                </div>
            ...
            <?php endif ?>
             ...
             <form method = "POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <a href="admin-wedding.php" class="btn btn-lg btn-danger"><i class="fa fa-image"> Wedding Gallery</i></a>
                </div>               
