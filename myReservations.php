            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="active" href="myReservations.php">My Reservations</a></li>
                        <li><a href="myRequest.php">My Requests</a></li>
...
<div class="container-fluid" style="padding-bottom: 160px">
		<div class="col-md-8 col-md-offset-2">
			<form class="form">
				<div class="row">
					<hr class="invis">
				 <p class="text-center" style="font-family: Gebriola; font-size: 30px; color: black"><b>My Reservations</b></p>
                ...
                <?php endif ?>
		 		...
		 		<table class="table" style="font-size: 13px">
					...
					$sql = "SELECT * FROM signup
						    ...
						    WHERE customer_reservation.customer_id ='".$id."'";
