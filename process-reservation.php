...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE customer_reservation SET status ='".$status."', reason = '".$reason."' WHERE transaction_id = '".$reserved_id."'";
      ...
      <div class="row">
        ...
        <div class="col-8">
          <div class="form-group">
            <h3>Processing <span style="color: orange"><?php echo $reserved_row['firstName']; ?> <?php echo $reserved_row['lastName']; ?> </span>  Reservation</h3>
            ...
            <?php endif ?>
             ...
             <form class="form" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="transaction_id" value="<?php echo $reserved_row['transaction_id'];?>">
                </div>
